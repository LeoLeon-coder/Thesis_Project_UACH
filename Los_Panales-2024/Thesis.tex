...
\begin{tightmulticols}
Inicialmente se determinó el formato de los archivos de audio y la razón de muestreo. En este estudio, se utiliza una razón de muestreo de 16 kHz con un formato de mono-audio.
